...
public class Human {
    ...
    public Human(String name, int jumpPosibility, int runPosibility) {
        this.name = name;
    ...
    public void run(RunRoad road) {
        if (runPosibility > road.getLength()) {
            System.out.println("Human Run through RunRoad");
        } else {
            System.out.println("Human exhausted and can't run trough this Road");
        }
    ...
    public void jump (Wall wall){
        if (jumpPosibility > wall.getHigh()) {
            System.out.println("Human jump through Wall");
        }
        else {
            System.out.println("Human is small and can't jump trough this Wall");
        }
    }
